...
Let us remove "Cells - Cultured fibrolasts" and "Cells - EBV-transformed lymphocytes," because they are cell cultures and not primary tissues. Let us also remove "Whole Blood" as it may be a very diverse "tissue":
...
Load the table of normalized isoform counts:

```{r, include=T}
# selected.table.log2 = read.delim("data/results/gtex8_processed/tfs_nontfs_selected_samples_tpm_log2.tsv",
#                                  header = T,
#                                  sep = "\t",
#                                  stringsAsFactors = F)
# selected.table.whole.log2 = read.delim("data/results/gtex8_processed/tfs_nontfs_selected_samples_tpm_whole_log2.tsv",
#                                        header = T,
#                                        sep = "\t",
#                                        stringsAsFactors = F)
```
...
```{r, include=T}
# selected.table.genes.log2 = read.delim("data/results/gtex8_processed/tfs_nontfs_selected_samples_genes_tpm_log2.tsv",
#                                        header = T,
#                                        sep = "\t",
#                                        stringsAsFactors = F)
# 
...
Calculate gene tissue specificity as a number of tissue where a gene is expressed:
